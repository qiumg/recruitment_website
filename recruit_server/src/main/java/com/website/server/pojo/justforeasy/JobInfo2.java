...
public class JobInfo2 {
    ...
    public JobInfo2(Integer jId, String jName, String jCharacter, String jk2Name, Integer jMlow, Integer jMhigh, String jEducation, String jExperience, Date jDate, Integer jNum, String jLoc, String jReq, String jDes, String jBenefit, Integer cId, String jkName, String jk1Name, Integer jClick) {
        this.jId = jId;
        this.jName = jName;
        this.jCharacter = jCharacter;
        this.jk2Name = jk2Name;
